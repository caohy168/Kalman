...
void Noise (Noise_variable Ts,
  Noise_variable detav,Noise_variable detaw,
  Noise_variable Q[3][3],Noise_variable R,
  Noise_variable V[20000],Noise_variable W[3][20000]){_ssdm_SpecArrayDimSize(Q, 3);_ssdm_SpecArrayDimSize(V, 20000);_ssdm_SpecArrayDimSize(W, 3);
...
void CarrierTracking(kalman_variable Ts,
      int DotNumber,
      kalman_variable DeltaThetaInitinital,kalman_variable Omega0Initinital,kalman_variable Omega1Initinital,
      kalman_variable DetaTheta[10000],kalman_variable Omega0[10000],kalman_variable Omega1[10000]) {_ssdm_SpecArrayDimSize(DetaTheta, 10000);_ssdm_SpecArrayDimSize(Omega0, 10000);_ssdm_SpecArrayDimSize(Omega1, 10000);
_ssdm_op_SpecInterface(DeltaThetaInitinital, "ap_vld", 0, 0, "", 0, 0, "", "", "", 0, 0, 0, 0, "", "");
# 41 "../Kalman.cpp"

_ssdm_op_SpecInterface(DotNumber, "ap_vld", 0, 0, "", 0, 0, "", "", "", 0, 0, 0, 0, "", "");
# 41 "../Kalman.cpp"

_ssdm_op_SpecInterface(Omega0Initinital, "ap_vld", 0, 0, "", 0, 0, "", "", "", 0, 0, 0, 0, "", "");
# 41 "../Kalman.cpp"

_ssdm_op_SpecInterface(Omega1Initinital, "ap_vld", 0, 0, "", 0, 0, "", "", "", 0, 0, 0, 0, "", "");
# 41 "../Kalman.cpp"

_ssdm_op_SpecInterface(Ts, "ap_vld", 0, 0, "", 0, 0, "", "", "", 0, 0, 0, 0, "", "");
# 41 "../Kalman.cpp"

_ssdm_op_SpecInterface(DetaTheta, "axis", 1, 1, "both", 0, 0, "", "", "", 0, 0, 0, 0, "", "");
# 41 "../Kalman.cpp"

_ssdm_op_SpecInterface(Omega0, "axis", 1, 1, "both", 0, 0, "", "", "", 0, 0, 0, 0, "", "");
# 41 "../Kalman.cpp"

_ssdm_op_SpecInterface(Omega1, "axis", 1, 1, "both", 0, 0, "", "", "", 0, 0, 0, 0, "", "");
# 41 "../Kalman.cpp"



kalman_variable X[3][20000];
kalman_variable X_pre[3][20000];
kalman_variable Xkf[3][20000];
kalman_variable Z[20000];
kalman_variable P0[3][20000];
kalman_variable P1[3][20000];
kalman_variable P2[3][20000];
kalman_variable P_pre0[3][20000];
kalman_variable P_pre1[3][20000];
kalman_variable P_pre2[3][20000];
kalman_variable A[3][3];
kalman_variable H[3];
kalman_variable B[3];
kalman_variable V[20000];
kalman_variable W[3][20000];

kalman_variable kgd;
kalman_variable kgn[3];
kalman_variable Kg[3];
 ...
 kalman_variable detav=1e-3;
 kalman_variable detaw=1e-3;
