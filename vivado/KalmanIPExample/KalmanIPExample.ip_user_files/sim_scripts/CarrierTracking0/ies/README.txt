...
#
# Generated by export_simulation on Sun Sep 27 00:03:18 PDT 2020
#
################################################################################
...
'-reset_run' switch to the './CarrierTracking0.sh' script.

./CarrierTracking0.sh -reset_run
...
./CarrierTracking0.sh -noclean_files

For more information on the script, please type './CarrierTracking0.sh -help'.
